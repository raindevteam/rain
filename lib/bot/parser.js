...
/**
 * Returns text command without any denotion header (commandPrefix,
 * or commandSymbol).
 *
 * @param {String} text - The text command with denotion header.
 */
...
module.exports = {
  ...
  /**
   * Checks if the text passed in is a command. If no denotion
   * header is included, it checks if any command prefixed words
   * are actual commands.
   *
  ...
  /**
   * Parses a raw command into a list of commands. It also escapes, and ignores
   * double ampersands.
   *
   * @param {String} text - Raw command to parse.
   */
